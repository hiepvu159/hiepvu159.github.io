...
import Controller.ProductTypeDAO;
...
//    private int[] sponsorIndexArr;
    ...
    public ProductForm() {
        ...
        btnUpdateSP.setForeground(Color.BLACK);
        btnDeleteSP.setForeground(Color.BLACK);
        btnResetSP.setForeground(Color.BLACK);
        //--------------------------------------------
//        tblSP.setBackground(Color.DARK_GRAY);
    ...
    private void initComponents() {
        ...
        jPanel1 = new javax.swing.JPanel(){
            ImageIcon icon = new ImageIcon("image//back-ground.png");
        ...
        jPanel2.setBackground(new java.awt.Color(147, 233, 177));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addComponent(txtIDProductType, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGap(62, 62, 62)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cbSizeType, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtNameType, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addComponent(jPanel6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(128, 128, 128))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
        ...
        btnUpdateSP.setForeground(new java.awt.Color(51, 51, 51));
        ...
        btnDeleteSP.setForeground(new java.awt.Color(51, 51, 51));
    ...
    private void btnDeleteSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteSPActionPerformed
        ...
        if (de == 0) {
                ...
                if(pdd.checkDeleteProduct(pd)){
                    pdd.deleteProduct(pd);
                    loadDataSP();
                    btnResetActionPerformed(null);
                    JOptionPane.showMessageDialog(null, "Xoa San Pham thanh cong");
                }else JOptionPane.showMessageDialog(null, "Khong the xoa san pham");
        ...
        // TODO add your handling code here:
                ...
                if (click == 0) {
                    try {
                        ...
                        pdt.setIDType(txtIDProductType.getText());
                        ProductTypeDAO ptd = new ProductTypeDAO();
                        ptd.deleteProductType(pdt);
    ...
    private void btnSuaLoaiSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaLoaiSPActionPerformed
        ...
        if (click == 0) {
            try {
                ProductType pdt = new ProductType();
                pdt.setIDType(txtIDProductType.getText());
                pdt.setTypeName(txtNameType.getText());
                pdt.setSize(cbSizeType.getSelectedItem().toString());
                ProductTypeDAO ptd = new ProductTypeDAO();
                ptd.updateProductType(pdt);
                tblModelLoaiSP.getDataVector().removeAllElements();
                loadDataLoaiSP();
                btnResetActionPerformed(null);
