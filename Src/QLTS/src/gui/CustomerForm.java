...
//            Customer cus = new Customer();
            cus.setIDCus(Integer.valueOf(lbID.getText()));
            cusd.delelteCus(cus);
...
//            CustomerDAO cusd = new CustomerDAO();
            ...
            cus.setIDCus(Integer.valueOf(lbID.getText()));
            cusd.updateCus(cus);
            JOptionPane.showMessageDialog(null, "Sửa đổi thông tin thành công");
            ReloadTable();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Sửa đổi thông tin thất bại");
        }
